...
csv_file_template = 'fea_ex_v2_nodes_{}.csv'
...
for y in y_values:
    ...
    for audio_file in audio_files:
        ...
        row_data = [audio_file, x_value, y, fit_result[0], fit_result[1], np.round(fit_result[2][0][0], 2),
                    np.round(fit_result[2][0][1], 2), *stats_result]
        all_results.append(row_data)

    csv_file_path = csv_file_template.format(y)
    ...
    print(f"Results for {y} nodes saved to {csv_file_path}")
